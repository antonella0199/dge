      ...
      <header>
         ...
         <div class="header-top">
            ...
            <div class="card" style="opacity: .8">
                <h2 class="card-header">Estadísticas en tiempo real.</h2>
                <div class="card-body">
                   <p style="color:black"> Esta página nació como un proyecto de Tesís de la carrera Tec. Universitaria en Programación.</p><br>
                   <p style="color:black"> Busca incorporar informacion de todas las instituciones presentes en la Provincia de Salta y las problematicas barriales que reporten los vecinos.</p><br>
                   <p style="color:brown"><b> Actualmente la página se encuentra en desarrollo. </b></p>
                </div>
              </div>
            </div>
            </section>
